...
var url = "https://api.github.com/search/code?q=repo%3Atddbin%2Fkatas+language%3AJavaScript+path%3Akatas%2Fes6%2Flanguage";

atomic.get(url).success(function (data) {
  render(data.items.map(function (item) {
    return item.path;
  }));
